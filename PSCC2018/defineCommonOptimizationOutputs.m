...
Network.Optimization.L2L1=mean(Network.Optimization.Constraints.BranchConstraints.W3PhiLambdas(end-1,:)...
 ...
 Network.Optimization.L3L1=mean(Network.Optimization.Constraints.BranchConstraints.W3PhiLambdas(end-2,:)...
     ./Network.Optimization.Constraints.BranchConstraints.W3PhiLambdas(end,:));
 Network.Optimization.Constraints.BranchConstraints.UPsi3PhiLambdas=BranchConstraints.UPsi3Phi.Lambdas;
Network.Optimization.L2L1U=mean(Network.Optimization.Constraints.BranchConstraints.UPsi3PhiLambdas(end-1,:)...
     ./Network.Optimization.Constraints.BranchConstraints.UPsi3PhiLambdas(end,:));
 Network.Optimization.L3L1U=mean(Network.Optimization.Constraints.BranchConstraints.UPsi3PhiLambdas(end-2,:)...
     ./Network.Optimization.Constraints.BranchConstraints.UPsi3PhiLambdas(end,:));
